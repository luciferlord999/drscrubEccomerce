        ...
        <div className="container-fluid">
          <div className="main__footer d-flex justify-content-between">
            <div className="footer__widget footer__widget--width">
              ...
              <div className="footer__widget--inner">
                <p className="footer__widget--desc text-ofwhite mb-20">
                  ...
                  <br /> seddo eiusmod tempor incididunt utlabore et dolore{" "}
                  <br /> magna aliqua enim ad minim veniam quisnostrud <br />{" "}
                  exercitation ullamco
                </p>
                <div className="footer__social">
                  <h3 className="social__title text-ofwhite h4 mb-15">
                    Follow Us
                  </h3>
            ...
            <div className="footer__widget--menu__wrapper d-flex footer__widget--width">
              ...
              <div className="footer__widget">
                ...
                <ul className="footer__widget--menu footer__widget--inner">
                  <li className="footer__widget--menu__list">
                    <a className="footer__widget--menu__text" href="/about-us">
                      About Us
                    </a>
                  </li>
                  {/* <li className="footer__widget--menu__list">
              ...
              <div className="footer__instagram footer__widget--inner">
                <div className="footer__instagram--list d-flex">
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram1.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram2.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram3.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
                ...
                <div className="footer__instagram--list d-flex">
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram4.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram5.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
                  <div className="instagram__thumbnail">
                    ...
                    >
                      <img
                        src="assets/img/other/instagram6.webp"
                        alt="instagram"
                      />
                    </a>
                  </div>
          ...
          <div className="footer__bottom d-flex justify-content-between align-items-center">
            <p className="copyright__content text-ofwhite m-0">
              ...
              . All Rights Reserved.Design By Digital Nawab
            </p>
